<template>
    <div class="home">
        ...
        <Card :bordered="false" style="width:600px;text-align: left;margin:100px;">
            ...
            <CascaderWithLabel label="行业分类" v-model="form[2]" :data="cascader_data"
                               :initValue="cascader_init"></CascaderWithLabel>
            <CascaderWithInputWithLabel label="行业分类" v-model="form[3]" :data="cascader_data"
                                        :initValue="cascader_init"></CascaderWithInputWithLabel>
            <CascaderWithInputWithLabel style="width:300px;margin-right: 30px" v-for="item in testdata" :key="item.id"
                                        :name="item.name"
                                        :data="gangWeiLeiBie"></CascaderWithInputWithLabel>
        </Card>
